...
errorMessage_2 = "Я пока не знаю, в какой группе ты обучаешься. " \
                 ...
                 "\n1. Перейди на сайт https://ruz.spbstu.ru, выбери свой институт и группу" \
...
scheduleMessage_2 = "*Радуйся, политехник! {0} занятий нет.*"
...
settingsMessage_4 = "Я политехник - неофициальный бот Политехнического университета." \
                 ...
                 "абсолютно для всех устройств вне зависимости от их платформы и везде выглядит одинаково. " \
                    ...
                    "\n/settings - отображение меню настроек" \
                    "\n/schedule - доступ к расписанию" \
                    "\n/tschedule - доступ к расписанию преподавателей" \
                    "\n/routes - построение маршрутов" \
                    "\n/find - поиск данных преподавателей и администрации" \
                    "\n/dogs и /cats - собачки и котики для снятия морального напряжения" \
                    "\n\ncreated by @muratop1gg with support by @lrrrtm"
settingsMessage_5 = "Хэй, {0}!\nВот список доступных команд: " \
                    "\n/help - отображение списка доступных команд" \
                    "\n/settings - отображение меню настроек" \
                    "\n/schedule - доступ к расписанию" \
                    "\n/tschedule - доступ к расписанию преподавателей" \
